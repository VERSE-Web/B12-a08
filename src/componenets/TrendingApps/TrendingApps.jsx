...
const TrendingApps = ({ trendingAppsPromise }) => {
  const trendingApps = use(trendingAppsPromise);

  return (
    <div className="min-h-screen bg-[#F5F5F5] p-6">
      {/* Header Section */}
      <div className="rounded-lg p-6 mb-4 text-center bg-[#F5F5F5]">
        <h1 className="text-4xl font-bold text-gray-800 mb-2">Trending Apps</h1>
      ...
      <div className="flex justify-center mt-6">
        <Link to='/apps' className="bg-violet-500 hover:bg-violet-600 active:bg-violet-700 text-white font-medium text-sm px-8 py-2.5 rounded-lg transition-colors duration-150">
          Show All
        </Link>
      </div>
    </div>
